...
New quarto file to update Great Slave Lake Lake Trout mortality rate estimate from East Arm, using 2023 data from LKDFN (oto ages, n=128 ages, 72 missing oto from one fisher)
(no Main Basin/KFN LKTR samples from community sampling in 2023 b/c of wildfire evaculations)
...
lktrccresults <- chapmanRobson(catch~age,data=subset_data) # data frame 1 is year 1947, 38 is 2022
