...
# Plot catch curves in groupd, to better show ages included in mortatliy rate estimates (filled circles)
...
inco_filtered <- subset(inco, year >= 1947 & year <= 1979) 
   
subset_data_filtered <- subset(subset_data, year >= 1947 & year <= 1979)   
...
inco_filtered <- subset(inco, year >= 1980 & year <= 1989) 
   
subset_data_filtered <- subset(subset_data, year >= 1980 & year <= 1989)   
...
inco_filtered <- subset(inco, year >= 1990 & year <= 1999) 
   
subset_data_filtered <- subset(subset_data, year >= 1990 & year <= 1999)   
...
inco_filtered <- subset(inco, year >= 2000 & year <= 2014) 
   
subset_data_filtered <- subset(subset_data, year >= 2000 & year <= 2014)   
...
inco_filtered <- subset(inco, year >= 2015 & year <= 2022) 
   
subset_data_filtered <- subset(subset_data, year >= 2015 & year <= 2022)   
